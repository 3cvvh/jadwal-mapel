    ...
    <div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-lg transform transition duration-500 hover:scale-105">
        ...
        <div x-data="{ show: <?php echo $status ? 'true' : 'false'; ?>, type: '<?php echo $status; ?>' }" x-show="show" x-transition class="mb-6">
            ...
            <div x-show="type === 'error'" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                ...
                <span class="block sm:inline">Data gagal ditambahkan.</span>
                <span class="absolute top-0 bottom-0 right-0 px-4 py-3 cursor-pointer" @click="show = false">&times;</span>
            </div>
        </div>
        ...
        <form action="" method="post" class="space-y-6">
            <div>
                ...
                <input type="text" id="senin" name="senin" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
            </div>
            <div>
                <label for="selasa" class="block text-gray-700 font-semibold mb-1">Selasa</label>
                <input type="text" id="selasa" name="selasa" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
            </div>
            <div>
                <label for="rabu" class="block text-gray-700 font-semibold mb-1">Rabu</label>
                <input type="text" id="rabu" name="rabu" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
            </div>
            <div>
                <label for="kamis" class="block text-gray-700 font-semibold mb-1">Kamis</label>
                <input type="text" id="kamis" name="kamis" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
            </div>
            <div>
                <label for="waktu" class="block text-gray-700 font-semibold mb-1">Waktu</label>
                <input type="text" id="waktu" name="waktu" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
            </div>
